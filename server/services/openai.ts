...
// Use shared type for consistency
export type AITaskSuggestion = AISuggestion;
...
Generate 8-12 specific, actionable maintenance tasks. For each item/task, provide:
